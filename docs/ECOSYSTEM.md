...
| **Butiks-ordrer (Supermarket)** | Send liste til butik → butik pakker + melder klar → bruger ser status | 🟡 DEMO bygget som **selvstændig app** (deler backend) | `apps/supermarket/` (butik) + `apps/meal-shopping/` (afsender) |
