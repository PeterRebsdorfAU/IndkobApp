...
## 📚 Dokumentation
Denne app ligger i monorepoet under `apps/meal-shopping/`. Se roden ([`../../README.md`](../../README.md)) for økosystemet.
- **[../../docs/ECOSYSTEM.md](../../docs/ECOSYSTEM.md)** — visionen og de samarbejdende systemer + ansvarsområder. *Send denne til andre agenter for kontekst.*
- **[ARCHITECTURE.md](ARCHITECTURE.md)** — teknisk dybde-reference for denne app (datamodel, auth, API, deploy).
