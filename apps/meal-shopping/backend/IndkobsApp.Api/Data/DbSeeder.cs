...
public static class DbSeeder
{
    ...
    {
        static CatalogRecipeIngredient L(string name, decimal qty, string unit) =>
        ...
        return new List<CatalogRecipe>
        {
            new CatalogRecipe
            {
                ...
                Ingredients =
                {
                    L("Kyllingebryst", 600, Units.G), L("Smør", 50, Units.G),
                    L("Løg", 1, Units.Stk), L("Hvidløg", 3, Units.Fed),
                    L("Hakkede tomater", 1, Units.Daase), L("Piskefløde", 250, Units.Ml),
                    L("Garam masala", 1, Units.Spsk), L("Ris", 300, Units.G)
                }
            },
            new CatalogRecipe
            {
                ...
                Ingredients =
                {
                    L("Røde linser", 300, Units.G), L("Løg", 1, Units.Stk),
                    L("Hvidløg", 2, Units.Fed), L("Hakkede tomater", 1, Units.Daase),
                    L("Kokosmælk", 1, Units.Daase), L("Karry", 1, Units.Spsk),
                    L("Ris", 300, Units.G)
                }
            },
            new CatalogRecipe
            {
                ...
                Ingredients =
                {
                    L("Hakket oksekød", 500, Units.G), L("Tortillas", 8, Units.Stk),
                    L("Tacokrydderi", 1, Units.Pakke), L("Salat", 1, Units.Stk),
                    L("Tomat", 2, Units.Stk), L("Revet ost", 200, Units.G),
                    L("Creme fraiche", 1, Units.Stk)
                }
            },
            new CatalogRecipe
            {
                ...
                Ingredients =
                {
                    L("Laksefilet", 500, Units.G), L("Kartofler", 800, Units.G),
                    L("Citron", 1, Units.Stk), L("Smør", 30, Units.G),
                    L("Broccoli", 1, Units.Stk)
                }
            },
            new CatalogRecipe
            {
                ...
                Ingredients =
                {
                    L("Kyllingebryst", 500, Units.G), L("Løg", 2, Units.Stk),
                    L("Æble", 1, Units.Stk), L("Karry", 2, Units.Spsk),
                    L("Piskefløde", 250, Units.Ml), L("Ris", 300, Units.G)
                }
            },
            new CatalogRecipe
            {
                ...
                Ingredients =
                {
                    L("Spaghetti", 400, Units.G), L("Bacon", 150, Units.G),
                    L("Æg", 3, Units.Stk), L("Parmesan", 80, Units.G),
                    L("Peber", 1, Units.Tsk)
                }
            },
            new CatalogRecipe
            {
                ...
                Ingredients =
                {
                    L("Gulerod", 400, Units.G), L("Kartofler", 400, Units.G),
                    L("Porre", 1, Units.Stk), L("Løg", 1, Units.Stk),
                    L("Grøntsagsbouillon", 1, Units.L), L("Rugbrød", 4, Units.Stk)
                }
            },
            new CatalogRecipe
            {
                ...
                Ingredients =
                {
                    L("Hakket svinekød", 500, Units.G), L("Æg", 1, Units.Stk),
                    L("Løg", 1, Units.Stk), L("Havregryn", 50, Units.G),
                    L("Mælk", 100, Units.Ml), L("Kartofler", 800, Units.G),
                    L("Creme fraiche", 1, Units.Stk), L("Purløg", 1, Units.Bundt)
                }
            },
            new CatalogRecipe
            {
                ...
                Ingredients =
                {
                    L("Æg", 4, Units.Stk), L("Hakkede tomater", 2, Units.Daase),
                    L("Løg", 1, Units.Stk), L("Peberfrugt", 1, Units.Stk),
                    L("Hvidløg", 2, Units.Fed), L("Spidskommen", 1, Units.Tsk),
                    L("Fetaost", 100, Units.G), L("Brød", 1, Units.Stk)
                }
            },
            new CatalogRecipe
            {
                ...
                Ingredients =
                {
                    L("Nudler", 250, Units.G), L("Kyllingebryst", 400, Units.G),
                    L("Gulerod", 200, Units.G), L("Spidskål", 0.5m, Units.Stk),
                    L("Soyasauce", 4, Units.Spsk), L("Hvidløg", 2, Units.Fed),
                    L("Ingefær", 1, Units.Stk)
                }
            },
            new CatalogRecipe
            {
                ...
                Ingredients =
                {
                    L("Hakket kalv og flæsk", 500, Units.G), L("Æg", 1, Units.Stk),
                    L("Løg", 1, Units.Stk), L("Hvedemel", 100, Units.G),
                    L("Karry", 2, Units.Spsk), L("Smør", 40, Units.G),
                    L("Mælk", 300, Units.Ml), L("Ris", 300, Units.G)
                }
            },
            new CatalogRecipe
            {
                ...
                Ingredients =
                {
                    L("Hakket oksekød", 500, Units.G), L("Løg", 1, Units.Stk),
                    L("Hvidløg", 2, Units.Fed), L("Hakkede tomater", 2, Units.Daase),
                    L("Lasagneplader", 1, Units.Pakke), L("Smør", 40, Units.G),
                    L("Hvedemel", 40, Units.G), L("Mælk", 500, Units.Ml),
                    L("Revet ost", 150, Units.G)
                }
            },
            new CatalogRecipe
            {
                ...
                Ingredients =
                {
                    L("Hakket oksekød", 500, Units.G), L("Løg", 1, Units.Stk),
                    L("Hvidløg", 2, Units.Fed), L("Hakkede tomater", 2, Units.Daase),
                    L("Kidneybønner", 1, Units.Daase), L("Majs", 1, Units.Daase),
                    L("Chilikrydderi", 1, Units.Spsk), L("Ris", 300, Units.G)
                }
            },
            new CatalogRecipe
            {
                ...
                Ingredients =
                {
                    L("Æg", 8, Units.Stk), L("Mælk", 100, Units.Ml),
                    L("Bacon", 150, Units.G), L("Purløg", 1, Units.Bundt),
                    L("Tomat", 2, Units.Stk), L("Rugbrød", 4, Units.Stk)
                }
            },
            new CatalogRecipe
            {
                ...
                {
                    L("Hakket oksekød", 500, Units.G), L("Løg", 1, Units.Stk),
                    L("Hvedemel", 2, Units.Spsk), L("Oksebouillon", 0.5m, Units.L),
                    L("Kartofler", 800, Units.G), L("Smør", 30, Units.G),
                    L("Mælk", 100, Units.Ml)
                }
            },
            new CatalogRecipe
            {
                ...
                Ingredients =
                {
                    L("Hvidfiskefilet", 500, Units.G), L("Æg", 1, Units.Stk),
                    L("Hvedemel", 2, Units.Spsk), L("Løg", 1, Units.Stk),
                    L("Smør", 40, Units.G), L("Remoulade", 1, Units.Stk),
                    L("Citron", 1, Units.Stk), L("Rugbrød", 4, Units.Stk)
                }
            },
            new CatalogRecipe
            {
                ...
                Ingredients =
                {
                    L("Kartofler", 800, Units.G), L("Løg", 2, Units.Stk),
                    L("Kogt kød", 400, Units.G), L("Æg", 4, Units.Stk),
                    L("Rødbeder", 1, Units.Daase), L("Smør", 30, Units.G)
                }
            },
            new CatalogRecipe
            {
                ...
                Ingredients =
                {
                    L("Hvedemel", 500, Units.G), L("Gær", 25, Units.G),
                    L("Olivenolie", 2, Units.Spsk), L("Tomatsauce", 1, Units.Daase),
                    L("Revet ost", 200, Units.G), L("Skinke", 100, Units.G)
                }
            }
        };
    }
    ...
    public static async Task SeedAsync(AppDbContext db, IPasswordHasher<Household> hasher, IConfiguration cfg)
    {
        ...
        var spagBolognese = new Recipe
        {
            ...
            Ingredients =
            {
                new RecipeIngredient { Ingredient = spaghetti, Quantity = 400, Unit = Units.G },
                new RecipeIngredient { Ingredient = hakkokse,  Quantity = 500, Unit = Units.G },
                new RecipeIngredient { Ingredient = løg,       Quantity = 2,   Unit = Units.Stk },
                new RecipeIngredient { Ingredient = hvidløg,   Quantity = 2,   Unit = Units.Fed },
                new RecipeIngredient { Ingredient = tomat,     Quantity = 2,   Unit = Units.Daase },
                new RecipeIngredient { Ingredient = oliven,    Quantity = 2,   Unit = Units.Spsk },
                new RecipeIngredient { Ingredient = parmesan,  Quantity = 50,  Unit = Units.G },
                new RecipeIngredient { Ingredient = salt,      Quantity = 1,   Unit = Units.Tsk },
            }
        };
        ...
        var gulerodssuppe = new Recipe
        {
            ...
            Ingredients =
            {
                new RecipeIngredient { Ingredient = gulerod, Quantity = 500, Unit = Units.G },
                new RecipeIngredient { Ingredient = løg,     Quantity = 1,   Unit = Units.Stk },
                new RecipeIngredient { Ingredient = smør,    Quantity = 30,  Unit = Units.G },
                new RecipeIngredient { Ingredient = mælk,    Quantity = 500, Unit = Units.Ml },
            }
        };
        ...
        var frokost = new ItemGroup
        {
            ...
            Ingredients =
            {
                new ItemGroupIngredient { Ingredient = rugbrød, Quantity = 1, Unit = Units.Pakke },
                new ItemGroupIngredient { Ingredient = hamburgerryg, Quantity = 1, Unit = Units.Stk },
                new ItemGroupIngredient { Ingredient = smør, Quantity = 200, Unit = Units.G },
            }
        };
        ...
        var toilet = new ItemGroup
        {
            ...
            Ingredients =
            {
                new ItemGroupIngredient { Ingredient = toiletpapir, Quantity = 1, Unit = Units.Pakke },
                new ItemGroupIngredient { Ingredient = sæbe, Quantity = 2, Unit = Units.Stk },
            }
        };
